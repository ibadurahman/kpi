        ...
        $("#m_tree_3").jstree( {
            plugins:["wholerow", "checkbox", "types"], core: {
                ...
                , data:[ {
                    ...
                    , {
                        text:"initially open", icon:"fa fa-folder m--font-default", state: {
                            opened: !0
                        }
                    ...
                    , {
                        text:"disabled node", icon:"fa fa-check m--font-success", state: {
                            disabled: !0
                        }
                    }
                    ]
        ...
        $("#m_tree_4").jstree( {
            core: {
                ...
                , check_callback:!0, data:[ {
                    ...
                    , {
                        text:"Initially open", icon:"fa fa-folder m--font-success", state: {
                            opened: !0
                        }
                        , children:[ {
                    ...
                    , {
                        text: "Another Custom Icon", icon: "fa fa-warning m--font-waring"
                    }
                    , {
                        text:"Disabled Node", icon:"fa fa-check m--font-success", state: {
                            disabled: !0
                    ...
                    , {
                        text:"Sub Nodes", icon:"fa fa-folder m--font-danger", children:[ {
