						...
						<div class="m-card-profile__pic-wrapper">
                                                    <?php 
                                                        if($RowData->foto!=""){
                                                            ...
                                                            //$this->session->set_userdata("login_foto",$RowData->foto);
                                                        }else{
...
<!--							<div class="form-group m-form__group m--margin-top-10 m--hide">
							...
							<div class="form-group m-form__group row">
                                                                <?php echo form_label($this->lang->line('tgl_masuk'),'tgl_masuk',array("class"=>"col-2 col-form-label"));?>
								<div class="col-7">
                                                                    <span class="col-form-label" style="padding-top: .85rem; display: inline-block"><?php echo convert_date($RowData->tgl_masuk); ?></span>
								</div>
							</div>
							<div class="form-group m-form__group row">
                                                                <?php echo form_label($this->lang->line('dob'),'dob',array("class"=>"col-2 col-form-label"));?>
								<div class="col-7">
							...
							<div class="form-group m-form__group row">
                                                                <?php echo form_label($this->lang->line('jenis_kelamin'),'jenis_kelamin',array("class"=>"col-2 col-form-label"));?>
								<div class="col-7">
							...
							<div class="m-form__actions">
								<div class="row">
									...
									<div class="col-7">
										...
										<button type="button" onclick="window.location='<?php echo site_url('akses/Profile/edit_form/'.$RowData->id); ?>';" class="btn btn-accent m-btn m-btn--air m-btn--custom">Edit</button>&nbsp;&nbsp;
                                                                            <?php //} ?>
				...
				<div class="tab-pane " id="m_user_profile_tab_2">
                                        <?php echo form_open('akses/Profile/change_password/'.$RowData->id,["class"=>"m-form m-form--fit m-form--label-align-right","id"=>"form_change_pass"]); ?>
