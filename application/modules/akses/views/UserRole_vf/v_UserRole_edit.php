...
<!--							<span class="m-portlet__head-icon">
			...
			<div class="m-portlet__body">
                                <?php echo form_open('akses/UserRole/edit/'.$DataRow->id,["class"=>"-form m-form--label-align-right m-form--state-","id"=>"form_input"]);
							...
							<div class="col-xl-8 offset-xl-2">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-xl-9 col-lg-9">
                                                                                    <?php echo form_textarea(array(
                                                                                                        ...
                                                                                                        ),set_value('description',$DataRow->description));
                                                                                    ?>
										</div>
									</div>
								</div>
								...
								<div class="m-form__section">
									...
									<div class="col-12">
															...
															<?php   
                                                                                                                                if(in_array($row->kd_permission, $ListPermGroup))
                                                                                                                                {
                                                                                                                                    $StatChecked=TRUE;
                                                                                                                                }
                                                                                                                                else
                                                                                                                                ...
                                                                                                                                echo form_checkbox(array(
                                                                                                                                            ...
                                                                                                                                            ),set_checkbox('kd_permission['.$a.']'),$StatChecked);
