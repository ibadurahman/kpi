...
//            $('#menu').val('tes');
            ...
            var UriDelete= "<?php echo site_url('akses/Permission/delete')?>";
            var DelMessage= "<?php echo $this->lang->line('sukses_delete');?>";
            var UriRedirect= "<?php echo site_url('akses/Permission/Index')?>";
	...
	"ajax": {
	        url: "<?php echo site_url('akses/Permission/get_list')?>",
               ...
               success: function(response){
                   ...
                   if(response.success == true){
                       //setelah sukses halaman d scroll ke top
                        ...
                        window.location = '<?php echo site_url('akses/Permission');?>';
                   }
                   else{
                       $(window).scrollTop(0);
    ...
    $('#button_add').on('click', function(){
            //alert('tes');
            var dataURL = "<?php echo site_url('akses/Permission/insert_form')?>";
            var action = "<?php echo site_url('akses/Permission/save')?>";
    ...
    $('#m_table_1').on('click', '.openPopupView', function(){
            ...
            var dataURL = "<?php echo site_url('akses/Permission/view_form/')?>"+dataId;
    ...
    $('#m_table_1').on('click', '.openPopupEdit', function(){
            var dataId = $(this).attr('data-id');
            var dataURL = "<?php echo site_url('akses/Permission/edit_form/')?>"+dataId;
            var action = "<?php echo site_url('akses/Permission/edit/')?>"+dataId;
