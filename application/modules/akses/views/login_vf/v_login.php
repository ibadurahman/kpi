				...
				<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<!--<img src="<?php //echo base_url();?>assets/metronic/assets/app/media/img/logos/logo-1.png">-->
						...
						<div class="m-login__signin">
							<div class="m-login__head">
								<!--<h3 class="m-login__title">Sign In To Admin</h3>-->
                                                        ...
                                                        <?php echo form_open('akses/Login/login',array('class'=>'m-login__form m-form'));?>
...
<!--									<div class="col m--align-right m-login__form-right">
								...
								<div class="m-login__form-action">
									<button id="m_login_signin_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn btn btn-success">Sign In</button>
								</div>
                                                        <?php echo form_close();?>
...
<!--						<div class="m-login__account">
		...
		<!--begin::Page Snippets -->
		<!--<script src="<?php //echo base_url();?>assets/metronic/assets/snippets/custom/pages/user/login.js" type="text/javascript"></script>-->
                <?php echo $filejs;?>
		<!--end::Page Snippets -->
	</body>
