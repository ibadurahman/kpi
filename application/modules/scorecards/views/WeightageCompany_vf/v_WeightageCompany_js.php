...
//            $('#menu').val('tes');
            ...
            var UriDelete= "<?php echo site_url('scorecards/WeightageCompany/delete')?>";
            var DelMessage= "<?php echo $this->lang->line('sukses_delete');?>";
            var UriRedirect= "<?php echo site_url('scorecards/WeightageCompany/Index')?>";
	...
	"language": {
            ...
            // },
            {
                targets:4, width:"83px"
            }
            
            ],
	"ajax": {
	        url: "<?php echo site_url('scorecards/WeightageCompany/get_list')?>",
                       ...
                       //setelah sukses halaman d scroll ke top
                        ...
                        if(stat==1){
                            if(response.status=='edit'){
                                window.location = '<?php echo site_url('scorecards/WeightageCompany/view_form/');?>'+response.nip;
                            }else{
                                window.location = '<?php echo site_url('scorecards/WeightageCompany');?>';
                            }
                            
                        }else{
                            window.location = '<?php echo site_url('scorecards/WeightageCompany/insert_form');?>';
                        }
