...
<!--							<span class="m-portlet__head-icon">
					...
					<div class="m-portlet__head-tools">
                                            <a href="<?php echo site_url('scorecards/Measurement'); ?>" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
							<span>
			...
			<div class="m-portlet__body">
                                <?php echo form_open_multipart('scorecards/Measurement/save/'.$DataTahun,["class"=>"-form m-form--label-align-right m-form--state-","id"=>"form_input"]);
