			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					...
					<li class="m-portlet__nav-item">
                                            <a href="<?php echo site_url('scorecards/WeightagePeg/insert_form'); ?>" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air" id="button_add" >
							<span>
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            <thead>
                                    <tr>
                                            ...
                                            <th><?php echo $this->lang->line('kd_pk')?></th>
                                            <th></th>
                                    </tr>
                            </thead>
                    </table>
