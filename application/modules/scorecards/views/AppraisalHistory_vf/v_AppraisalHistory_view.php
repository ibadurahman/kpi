...
<div class="m-form__section m-form__section--first">
    <div class="m-form__heading">
        ...
        <a href="<?php echo site_url('scorecards/AppraisalHistory/cetak_appraisal_Pdf/'.$DataRow->kd_appraisal); ?>" target="_blank" class="btn btn-success m-btn m-btn--icon" id="button_print" >
                <span>
