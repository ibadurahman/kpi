		...
		<div class="m-portlet m-portlet--full-height  ">
            ...
            <div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
                <div class="m-demo__preview" style="border: none; padding: 0;">
                    ...
                    <?php
                    if(isset($ListBusinessDriver))
                    {
                        $KdPerspectiveTemp='';
                        $No=1;
                        // $Kode=$this->uri->segment(4);
                        $Kode=$data_kd_bd;
                        $arr=$ListBusinessDriver->result_array();
                        $key = array_search($Kode, array_column($arr, 'kd_bd'));
                        if(!empty($arr)){
                            $ps=$arr[$key]['kd_perspective'];
                        }else{
                            $ps='';
                        }
                        //$ps=$arr[$key]['kd_perspective'];
                        // echo $ps;
                        // die;
                        foreach ($ListBusinessDriver->result() as $row)
                        {
                            $cls="";
                            $show='';
                            $clsHeader='';
                            ...
                            if($row->kd_perspective==$ps){
                                $show='show';
                                $clsHeader="m-nav__item--active";
                            }
                    ?>
                    <?php
                            if($KdPerspectiveTemp!=$row->kd_perspective){
                                $KdPerspectiveTemp=$row->kd_perspective;
                                $hrefLink='#m_nav_sub_'.$KdPerspectiveTemp;
                                $hrefId='m_nav_sub_'.$KdPerspectiveTemp;
                                if($No==1){
                    ?>
                    ...
                    ?>
                                <li class="m-nav__item <?php echo $cls ?>">
									<a href="<?php echo site_url('scorecards/BusinessDriver/index/'.$row->kd_bd."/".$DataTahun."/".$DataBulan)?>" class="m-nav__link">
										<!-- <span class="m-nav__link-bullet m-nav__link-bullet--line">
											<span></span>
										</span> -->
										<span class="m-nav__link-title">
											<span class="m-nav__link-wrap">
												<span class="m-nav__link-text"><?php echo $row->nm_bd." (".$row->kd_bds.")"; ?></span>
												<span class="m-nav__link-badge">
                                                <?php 
                ...
                <!-- <div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true" data-height="1500" style="overflow:hidden; height: 1500px">
                        ...
                        //         if($No==1){
                            ?>
                                <div class="menu-header-group">
                                    <span class="header-text m--font-primary"><?php //echo $row->nm_perspective; ?></span>
                                    <span class="header-tambahan">
                                        <?php 
                                                    ...
                                                    // }
                                        ?>
                                        <a href="#" class="m-badge <?php //echo $clsWeightage; ?> m-badge--wide button_bobot" data-id="<?php //echo $row->kd_perspective; ?>" data-total-persen="<?php //echo $row->total_persen; ?>"><?php //echo $row->total_persen."%"; ?></a>
                                    </span>
                                </div>
                            ...
                            ?>          
                                    <div class="m-list-timeline__item">
                                            ...
                                            <span class="m-list-timeline__text">
                                                <a href="<?php //echo site_url('scorecards/BusinessDriver/index/'.$row->kd_bd."/".$DataTahun."/".$DataBulan)?>" class="nav-link">
                                                        <span class="m-nav__link-text"><?php //echo $row->nm_bd." (".$row->kd_bds.")"; ?></span>
                                                </a>
                                            </span>
                                            <span class="m-list-timeline__time ">
                                                <?php 
                                                    ...
                                                    // }
                                                ?>
                                                <a href="#" class="m-badge <?php //echo $clsWeightageDetail; ?> m-badge--wide button_bobot" data-id="<?php //echo $row->kd_perspective; ?>" data-id2="<?php //echo $row->kd_bd; ?>" data-total-persen="<?php //echo $row->total_persen; ?>"><?php //echo $row->weightage."%"; ?></a>
                                            </span>
                                    </div>
                        <?php 
                        //             $No++;
                                    ...
                                    <div class="col-sm-12">
                                        <form class="m-form m-form--fit m-form--label-align-right form-horizontal">
                                                    <div class="form-group m-form__group m-form__section--first row">
                                                            <?php echo form_label($this->lang->line('kd_bd'),'kd_bd',array("class"=>"col-5 col-form-label"));?>
                                                            <div class="col-7">
                                                                <span class="col-form-label" style="padding-top: .85rem; display: inline-block"><?php echo $RowData->kd_bds; ?></span>
                                                            </div>
                                                    </div>
                                                    <div class="form-group m-form__group row">
                                                            <?php echo form_label($this->lang->line('nm_bd'),'nm_bd',array("class"=>"col-5 col-form-label"));?>
                                                            <div class="col-7">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                            <?php echo form_label($this->lang->line('weightage'),'weightage',array("class"=>"col-5 col-form-label"));?>
                                                            <div class="col-7">
                                                                <span class="col-form-label" style="padding-top: .85rem; display: inline-block">
                                                                    ...
                                                                    ?>
                                                                    <a href="#" class="m-badge <?php echo $clsWeightageDetail; ?> m-badge--wide button_bobot" data-id="<?php echo $RowData->kd_perspective; ?>" data-id2="<?php echo $RowData->kd_bd; ?>" data-total-persen="<?php echo $RowData->total_persen; ?>"><?php echo $RowData->weightage."%"; ?></a>
                                                                </span>
                                ...
                                <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                                <div class="m-portlet__head-title">
                                                        ...
                                                        <h3 class="m-portlet__head-text">
                                                                <?php echo $RowData->nm_bd." ".$this->lang->line('performance_history'); ?>
                                                        </h3>
                                                </div>
                                        </div>
                                </div>
                        ...
                        <div class="m-portlet m-portlet--mobile m-portlet--head-solid-bg" m-portlet="true">
                                <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                                <div class="m-portlet__head-title">
                                                        <h3 class="m-portlet__head-text">
                                                                <?php echo isset($result_header)?$RowData->nm_bd." ".$result_header:""; ?>
                                                        </h3>
                                                </div>
                                        </div>
                                </div>
                                <div class="m-portlet__body">
                                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_3">
                                            ...
                                            <tbody>
                                                <?php
                                                $no=1;
                                                foreach($Historybd->result() as $row){
                                ...
                                <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                                <div class="m-portlet__head-title">
                                                        ...
                                                        <h3 class="m-portlet__head-text">
                                                                <?php echo $RowData->nm_bd." ".$this->lang->line('performance')." ". getNamaBulan($DataBulan)." ".$DataTahun; ?>
                                                        </h3>
                                                </div>
                                        </div>
                                </div>
