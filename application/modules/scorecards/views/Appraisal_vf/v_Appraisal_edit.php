...
<!--    <div class="m-form__heading">
            ...
            <table class="table table-bordered table-hover m-table m-table--head-bg-accent">
                ...
                <tbody>
                    ...
                    foreach($DataKpiPegawai->result() as $row)
                    {
                        ...
                        $persen_kpi=round(($row->weightage_kpi/$row->Tot_bobot_kpi),4);
                        // $persen_bd=round(($row->weightage_bd/$row->Tot_bobot_bd),4);
                    ?>
                    <tr>
                        ...
                        <td width="200" class="p-1">
                            <?php 
                                    $aktual=0;
                                    if(isset($ListKPIAppraisal[$row->kd_measurement])){
                                        $aktual=$ListKPIAppraisal[$row->kd_measurement];
                                    }
    ...
    <div class="form-group m-form__group">
            ...
            <?php echo form_textarea(array(
                    ...
                    echo form_hidden("nip",$DataRow->nip); 
