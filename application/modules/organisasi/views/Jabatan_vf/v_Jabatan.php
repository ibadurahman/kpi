		...
		<div class="m-portlet__head">
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
                                    <?php if($this->mion_auth->is_allowed('add_jabatan')){ ?>
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            <thead>
                                    <tr>
                                            ...
                                            <th><?php echo $this->lang->line('nm_jabatan')?></th>
                                            <th><?php echo $this->lang->line('kd_level')?></th>
                                            <th></th>
                                    </tr>
                            </thead>
                    </table>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="la la-remove"></span>
                        ...
                        <?php echo form_open('organisasi/Level/save',["class"=>"m-form m-form--state","id"=>"form_input"]);?>
			<!--<form class="m-form m-form--fit m-form--label-align-right">-->
				...
				<div class="modal-footer">
                                    ...
                                    <?php if($this->mion_auth->is_allowed('edit_jabatan')){ ?>
