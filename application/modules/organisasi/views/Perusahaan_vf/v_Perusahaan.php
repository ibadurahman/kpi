		...
		<div class="m-portlet__head">
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
                                    <?php if($this->mion_auth->is_allowed('add_company')){ ?>
		...
		<div class="m-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            <thead>
                                    <tr>
                                            <th>No</th>
                                            <th><?php echo $this->lang->line('kd_perusahaan')?></th>
                                            <th><?php echo $this->lang->line('nm_perusahaan')?></th>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="la la-remove"></span>
                        ...
                        <?php echo form_open_multipart('organisasi/Perusahaan/save',["class"=>"m-form m-form--state","id"=>"form_input"]);?>
			<!--<form class="m-form m-form--fit m-form--label-align-right">-->
				...
				<div class="modal-footer">
                                    ...
                                    <?php if($this->mion_auth->is_allowed('edit_company')){ ?>
