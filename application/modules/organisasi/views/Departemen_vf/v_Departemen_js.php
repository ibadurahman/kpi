...
//            $('#menu').val('tes');
            ...
            var UriDelete= "<?php echo site_url('organisasi/Departemen/delete')?>";
            var DelMessage= "<?php echo $this->lang->line('sukses_delete');?>";
            var UriRedirect= "<?php echo site_url('organisasi/Departemen/Index')?>";
	...
	"ajax": {
	        url: "<?php echo site_url('organisasi/Departemen/get_list')?>",
               ...
               success: function(response){
                   ...
                   if(response.success == true){
                       //setelah sukses halaman d scroll ke top
                        ...
                        window.location = '<?php echo site_url('organisasi/Departemen');?>';
                   }
                   else{
                       $(window).scrollTop(0);
    ...
    $('#button_add').on('click', function(){
            //alert('tes');
            var dataURL = "<?php echo site_url('organisasi/Departemen/insert_form')?>";
            var action = "<?php echo site_url('organisasi/Departemen/save')?>";
    ...
    $('#m_table_1').on('click', '.openPopupView', function(){
            ...
            var dataURL = "<?php echo site_url('organisasi/Departemen/view_form/')?>"+dataId;
    ...
    $('#m_table_1').on('click', '.openPopupEdit', function(){
            var dataId = $(this).attr('data-id');
            var dataURL = "<?php echo site_url('organisasi/Departemen/edit_form/')?>"+dataId;
            var action = "<?php echo site_url('organisasi/Departemen/edit/')?>"+dataId;
