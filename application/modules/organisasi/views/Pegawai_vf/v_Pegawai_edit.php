...
<!--							<span class="m-portlet__head-icon">
			...
			<div class="m-portlet__body">
                                <?php echo form_open_multipart('organisasi/Pegawai/edit/'.$RowData->nip,["class"=>"-form m-form--label-align-right m-form--state-","id"=>"form_input"]);
									...
									<div class="form-group m-form__group">
                                                                                <?php echo form_label("<span class='m--font-danger'>*</span>".$this->lang->line('nip'),'nip');?>
                                                                                     <?php echo form_input(array(
                                                                                                        ...
                                                                                                        ),set_value('nip_baru',$RowData->nip));
                                                                                            echo form_hidden('nip',$RowData->nip) ;           
                                                                                    ?>
									</div>
									<div class="form-group m-form__group">
									...
									<div class="form-group m-form__group">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                <?php echo form_input(array(
                                                                                                        ...
                                                                                                        ),set_value('tgl_masuk',convert_date($RowData->tgl_masuk)));
                                                                                    ?>
                                                                        ...
                                                                        <div class="form-group m-form__group">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                <?php echo form_input(array(
                                                                                                        ...
                                                                                                        ),set_value('tgl_keluar',convert_date($RowData->tgl_keluar)));
                                                                                    ?>
										<div class="input-group-append">
											<span class="input-group-text">
												<i class="la la-calendar glyphicon-th"></i>
												...
												<i class="la la-calendar glyphicon-th"></i>
                                                                        ...
                                                                        <div class="form-group m-form__group">
                                                                                ...
                                                                                <?php echo form_dropdown('kd_departemen', 
                                                                                                            $ListDepartemen, 
                                                                                                            set_value('kd_departemen',$RowData->kd_departemen),
                                                                        ...
                                                                        <div class="form-group m-form__group">
                                                                                ...
                                                                                <?php echo form_dropdown('kd_jabatan', 
                                                                                                            $ListJabatan, 
                                                                                                            set_value('kd_jabatan',$RowData->kd_jabatan),
                                                                        ...
                                                                        <div class="form-group m-form__group">
                                                                                ...
                                                                                <?php echo form_dropdown('report_to', 
                                                                                                            $ListPegawai, 
                                                                                                            set_value('report_to',$RowData->report_to),
										...
										<div class="m-radio-inline">
											...
											<label class="m-radio m-radio--solid">
												...
												<span></span>
                                                                        ...
                                                                        <div class="form-group m-form__group">
                                                                                <?php echo form_label("<span class='m--font-danger'>*</span>".$this->lang->line('status'),'status');?>
										<div class="m-radio-inline">
											<label class="m-radio m-radio--solid">
                                                                                                <?php 
                                                                                                    $Status1=FALSE;
                                                                                                    ...
                                                                                                    switch($RowData->status){
                                                                                                        case '1': $Status1=TRUE;break;
                                                                                                        case '2': $Status2=TRUE;break;
                                                                                                    }
                                                                                                            echo form_radio(array(
                                                                                                                                'name'          => 'status',
                                                                                                                                'id'            => 'status',
                                                                                                                                'value'         => '1'
                                                                                                                        ),'',set_radio('status', '1',$Status1));
                                                                                                            echo $ListStatus['1'];
                                                                                                ?>
												<span></span>
											</label>
