		...
		<div class="m-portlet__head-tools">
			<ul class="m-portlet__nav">
				<li class="m-portlet__nav-item">
                                    <a href="<?php echo site_url("organisasi/Pegawai/view_form/".$RowData->nip."/".$DataTahun."/".$DataBulan) ?>" class="btn btn-info m-btn  m-btn--custom m-btn--icon m-btn--air" >
                                                <span>
							...
							<div class="m-wizard__steps">
								...
								<div class="m-wizard__step" m-wizard-target="m_wizard_form_step_3">
									<div class="m-wizard__step-info">
										...
										<div class="m-wizard__step-label">
											<?php echo $this->lang->line('wizard_menu4');?>
										</div>
										<div class="m-wizard__step-icon">
											<i class="la la-check"></i>
										</div>
								...
								<div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
									<div class="m-form__section m-form__section--first">
										<div class="m-form__heading">
											<h3 class="m-form__heading-title"><?php echo $this->lang->line('pegawaikpi_section1');?></h3>
										</div>
										<div class="form-group m-form__group row">
                                                                                        <?php echo form_label("<span class='m--font-danger'>*</span>".$this->lang->line('nip'),'nip',['class'=>"col-xl-3 col-lg-3 col-form-label"]);?>
											<div class="col-xl-9 col-lg-9">
												<span class="m-form__control-static"><?php echo $RowData->nip; ?></span>
                                                                                ...
                                                                                <div class="form-group m-form__group row">
                                                                                        <?php echo form_label("<span class='m--font-danger'>*</span>".$this->lang->line('nama'),'nama',['class'=>"col-xl-3 col-lg-3 col-form-label"]);?>
											<div class="col-xl-9 col-lg-9">
												<span class="m-form__control-static"><?php echo $RowData->nama; ?></span>
											</div>
										</div>
                                                                                <div class="form-group m-form__group row">
...
<!--                                                                                <div class="form-group m-form__group row">
                                                                                        <?php //echo form_label("<span class='m--font-danger'>*</span>".$this->lang->line('kd_jabatan'),'kd_jabatan',['class'=>"col-xl-3 col-lg-3 col-form-label"]);?>
											<div class="col-xl-9 col-lg-9">
												<span class="m-form__control-static"><?php //echo $RowData->nm_jabatan; ?></span>
											</div>
										</div>-->
									</div>
									...
									<div class="m-form__section">
										<div class="m-form__heading">
											<h3 class="m-form__heading-title">
												<?php echo $this->lang->line('pegawaikpi_section2');?>
											</h3>
										</div>
                                                                                <div class="form-group m-form__group row">
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <?php 
                                                                                                                    ...
                                                                                                                    echo form_checkbox(array(
                                                                                                                                        ...
                                                                                                                                        ),set_checkbox('kd_measurement'.$no),$checked);
                                                                                                                 ?>
                                                                                                        </td>
								...
								<div class="m-wizard__form-step" id="m_wizard_form_step_2">
									<div class="m-form__section m-form__section--first">
										<div class="m-form__heading">
											<h3 class="m-form__heading-title"><?php echo $this->lang->line('pegawaikpi_section2');?></h3>
										</div>
