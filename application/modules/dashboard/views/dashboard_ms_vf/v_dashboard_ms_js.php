                ...
                // Add series
                 series : [
                        { 
                            ...
                            data:[{value: <?php echo $score_ms; ?>, name: 'Score'}]
                        }]
            };
...
//
        ...
        function (ec) {
            ...
            chartOptions = {
                ...
                legend: {
                    ...
                    right: 10,
                    <?php
                        if(isset($chart_ms['legend'])){
                        $legend="'".implode("','", $chart_ms['legend'])."'";
                        echo "data: [".$legend."],";
                        }
                    ?>
                },
                ...
                // Add custom colors
                <?php
                    if(isset($chart_ms['color'])){
                        $color="'".implode("','", $chart_ms['color'])."'";
                        echo "color: [".$color."],";
                    }
                    ?>
                // Enable drag recalculate
                ...
                xAxis: [{
                    ...
                    boundaryGap: false,
                    <?php
                        if(isset($chart_ms['bulan'])){
                        $bulan="'".implode("','", $chart_ms['bulan'])."'";
                        echo "data: [".$bulan."]";
                        }
                    ?>
                }],
                ...
                series: [
                    <?php
                    if(isset($chart_ms['data_grafik'])){
                    foreach($chart_ms['data_grafik'] as $key=>$val){
 ...
 $(document).ready(function(){
    ...
    ?>
    var e = new Chartist.Pie("#m_chart_<?php echo $row->kd_departemen; ?>", {
                    series: [{
                        value: <?php echo $row->gross_point; ?>,
                        className: "<?php echo $row->nm_departemen; ?>",
                        meta: {
