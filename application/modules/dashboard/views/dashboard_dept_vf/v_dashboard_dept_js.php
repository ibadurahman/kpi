...
<script language="javascript" type="text/javascript">
    ...
    require(
        ...
        function (ec) {
            ...
            // Initialize chart
            // ------------------------------
            var myChart = ec.init(document.getElementById('<?php echo "chart-line-".$row->kd_departemen ?>'));
                ...
                // Add series
                 series : [
                        { 
                            ...
                            data:[{value: <?php echo $row->kpi_dept; ?>, name: ''}]
                        }]
            };
...
//                },2000);
    ...
    require(
        ...
        function (ec) {
            // Initialize chart
            // ------------------------------
            var myChart = ec.init(document.getElementById('chart-line-dept'));
            ...
            chartOptions = {
                ...
                series: [
                    ...
                    foreach($line_dept['data_grafik'] as $key=>$val){
                        $score_arr=array();
                        foreach($line_dept['bulan'] as $key_bln=>$val_bln){
                            if(isset($val['score'][$key_bln])){
                                $score_arr[$key_bln]=$val['score'][$key_bln];
                            }else{
                                $score_arr[$key_bln]=0;
                            }
