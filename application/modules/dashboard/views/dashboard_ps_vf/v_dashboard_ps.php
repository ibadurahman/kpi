...
<div class="row mb-3">
    <div class="col-12">
        <h3 class="m-subheader__title m-subheader__title--separator"><?php echo $nm_perspective; ?></h3>
    </div>
</div>
		...
		<div class="m-portlet m-portlet--full-height ">
			<div class="m-portlet__head">
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							<?php echo $this->lang->line('ps_detail'); ?>
						</h3>
					</div>
				</div>
								...
								<table class="table">
									...
									<thead>
										<tr>
											...
											<td class="m-widget11__app"><?php echo $this->lang->line('business_driver'); ?></td>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<span class="m-widget11__title"><?php echo $row->nm_bd; ?></span>
...
<div class="row mb-3">
    <div class="col-12">
        <h3 class="m-subheader__title m-subheader__title--separator"><?php echo $this->lang->line('ps_bd'); ?></h3>
    </div>
</div>
                ...
                <div class="m-portlet__body  m-portlet__body--no-padding">
                        <div class="row m-row--no-padding m-row--col-separator-xl">
                            ...
                            if(isset($data_bd))
                            {
                                foreach($data_bd->result() as $row)
                                {
                                    $Kode= encrypt_url($kd_perspective."|".$row->kd_bd);
                            ?>
                                <div class="col-xl-6">
...
<!--                                                        <span class="m-widget14__desc">
                                                ...
                                                <div class="row  align-items-center">
                                                        <div class="col">
                                                                <div id="m_chart_<?php echo $row->kd_bd; ?>" class="m-widget14__chart" style="height: 160px">
                                                                    <div class="m-widget14__stat"><a href="<?php echo site_url("dashboard/Dashboard/DashboardBd/".$Kode."/".$DataTahun."/".$DataBulan); ?>"><?php echo $row->gross_point; ?></a></div>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
