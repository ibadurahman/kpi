                ...
                // Add series
                 series : [
                        { 
                            ...
                            data:[{value: <?php echo $score_perspective; ?>, name: 'Score'}]
                        }]
            };
...
//
        ...
        function (ec) {
            ...
            chartOptions = {
                ...
                legend: {
                    ...
                    right: 10,
                    <?php
                        if(isset($chart_ps['legend'])){
                        $legend="'".implode("','", $chart_ps['legend'])."'";
                        echo "data: [".$legend."],";
                        }
                    ?>
                },
                ...
                // Add custom colors
                <?php
                    if(isset($chart_ps['color'])){
                        $color="'".implode("','", $chart_ps['color'])."'";
                        echo "color: [".$color."],";
                    }
                    ?>
                // Enable drag recalculate
                ...
                xAxis: [{
                    ...
                    boundaryGap: false,
                    <?php
                        if(isset($chart_ps['bulan'])){
                        $bulan="'".implode("','", $chart_ps['bulan'])."'";
                        echo "data: [".$bulan."]";
                        }
                    ?>
                }],
                ...
                series: [
                    <?php
                    if(isset($chart_ps['data_grafik'])){
                    foreach($chart_ps['data_grafik'] as $key=>$val){
 ...
 $(document).ready(function(){
    ...
    ?>
    var e = new Chartist.Pie("#m_chart_<?php echo $row->kd_bd; ?>", {
                    series: [{
                        value: <?php echo $row->gross_point; ?>,
                        className: "<?php echo $row->nm_bd; ?>",
                        meta: {
