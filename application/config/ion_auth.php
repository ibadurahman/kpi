...
$config['identity_secondary']         = 'username';          // ini untuk pengecekan login, sehigga login bisa menggunakan email dan username
...
$config['perusahaan_cookie_name'] = 'perusahaan_code';
