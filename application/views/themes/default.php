...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo isset($title_web)?$title_web:"KPI"; ?></title>
		...
		<link href="<?php echo base_url();?>assets/metronic/assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		...
		<!--RTL version:<link href="assets/demo/default/base/style.bundle.rtl.css" rel="stylesheet" type="text/css" />-->
                ...
                ?>
                <?php echo $this->load->get_section('viewcss');?>
		<!--end::Base Styles -->
		<!--<link rel="shortcut icon" href="<?php //echo base_url();?>assets/metronic/assets/demo/default/media/img/logo/favicon.ico" />-->
                <link rel="shortcut icon" href="<?php echo base_url();?>assets/img/logo-icon.ico" />
		<script>
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<!-- BEGIN: content -->
                                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                                    <!-- BEGIN: Subheader -->
                                    <?php echo $this->load->get_section('t_alert');?>
                                    <div class="m-subheader ">
                                            <div class="d-flex align-items-center">
                                                    <div class="mr-auto">
                                                            <h3 class="m-subheader__title m-subheader__title--separator"><?php echo isset($subheader)? $subheader:""; ?></h3>
                                                            <?php
									...
									<li class="m-nav__item m-nav__item--home">
                                                                            <a href="<?php echo site_url("dashboard/Home"); ?>" class="m-nav__link m-nav__link--icon">
									...
									<li class="m-nav__separator">-</li>
                                                    ...
                                                    <?php echo $this->load->get_section('w_subheader');?>
                                                
                                            </div>
                                    </div>
                                    <div class="m-content">
                                        <?php if(isset($AlertInput)){?>
                                        ...
                                        <?php } ?>
                                        <?php if(isset($WarningInput)){?>
                                        <div class="m-section__content">
                                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        </button>
                                                        <?php echo "<strong>Warning! </strong>".$WarningInput;?>
                                                </div>
                                        </div>
                                        <?php } ?>
                                        <?php echo $output;?>
...
<!--		<ul class="m-nav-sticky" style="margin-top: 30px;">
		...
		<script src="<?php echo base_url();?>assets/metronic/assets/vendors/custom/datatables/datatables.bundle.js" type="text/javascript"></script>
		...
		<!--end::Page Snippets -->
			...
			?><script src="<?php echo $file; ?>"></script><?php
                ...
                ?>
                <?php echo $this->load->get_section('viewjs');?>
	</body>
